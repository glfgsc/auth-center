 ...
 *
 * <p>权限集是系统权限模型的核心概念，每个权限集包含一组能力码（capabilities），
 * 用户通过关联权限集获得对应的操作权限。</p>
 */
public interface IPermissionSetService {
     ...
     * 保存权限集（新增或更新）.
     *
     * <p>若 id 为 {@code null} 则新增，否则更新已有记录。</p>
     *
     * @param ps 权限集实体
     * @return 保存后的权限集主键 ID
     */
     ...
     * 解析指定用户的权限集.
     *
     * <p>查询用户关联的权限集，若未关联则降级到默认 viewer 权限集。</p>
     *
     * @param userId 用户 ID
